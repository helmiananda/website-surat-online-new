...
$auto = mysqli_query($conn, "select max(no_surat_pengantar) as max_code from input_data_surat");
...
<head lang="en">
    ...
    <title> Isi Data & Download Surat Pengantar | Surat Online RT. 07</title>
        ...
        <div class="margin">
            <div class="kolom-tambahdata">
                ...
                <body>
                    ...
                    <h1 class="isidata-paragraf"> Isi Data Form Surat Pengantar</h1>
                    ...
                    <form action="" method="post">
                        <table border="0">
                            ...
                            <tr>
                                <td height="50px"> <label for="">Nomor Surat Pengantar</label>
                                </td>
                                <td> : <input type="text" name="no_surat_pengantar" id="no_surat_pengantar" value="<?php echo $no_surat_ket ?>" class="input" autocomplete="off" readonly required> </td>
                            ...
                            <tr>
                                <td></td>
                                <td> <button id="activateButton" type="submit" name="submit" class="button-submit-inputdatasurat" onclick="JavaScript:window.location.href='directdownload.php?file=Surat Pengantar RT.docx';"> Kirim </button>
                                    <button id="myButton" <?php
                                                            echo isset($_SESSION['buttonActivated']) ? '' : 'disabled'; ?> type="submit" name="submit" class="button-submit-inputdatasuratdownload" style="margin-left: 10px;" onclick="JavaScript:window.location.href='directdownload.php?file=Surat Pengantar RT.docx';"> Download Surat</button>
                            ...
                            <tr>
                                ...
                                <td> <input type="hidden" name="jenis_surat" id="jenis_surat" class="input" autocomplete="off" required readonly value="Surat Pengantar">
                                </td>
